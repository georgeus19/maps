...
PreferenceIndexAlreadyPresentException::PreferenceIndexAlreadyPresentException() : message_("Data index already present.") {}

PreferenceIndexAlreadyPresentException::PreferenceIndexAlreadyPresentException(const string & message) : message_(message) {}

PreferenceIndexAlreadyPresentException::PreferenceIndexAlreadyPresentException(std::string && message) : message_(move(message)) {}

const char* PreferenceIndexAlreadyPresentException::what() const _GLIBCXX_TXN_SAFE_DYN _GLIBCXX_NOTHROW {
    return message_.c_str();
}
